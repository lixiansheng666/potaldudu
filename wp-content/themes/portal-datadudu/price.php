...
<div class="price">
    ...
    <img src="<?php echo get_template_directory_uri(); ?>/images/priceHeader.jpg" width="100%" height="auto">
    </div>
    ...
    <div class="container-fluid FeaturedProjects" style="margin-top: 60px">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-2 col-sm-4">
                ...
                <h4>高性能</h4>
                <p>物联网大数据平台具备PB级高速数据分析及服务能力，扫清一切性能瓶颈，高效系统运行提供更好的用户体验。</p>
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-2 col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/ico/big-data.png" style="width: 130px;height: auto;">
                <h4>迈向大数据</h4>
                <p>物联网大数据平台提供多样化采集数据的可视化图形输出、多重算法数据分析、全方位数据智能预警、感应器指令管理，传感器远程调控等功能。轻松搭建出丰富的应用，让物联网大数据改变我们的生活。</p>
            </div>
            <div class="col-md-2"></div>
        </div>
    </div>
...
<div class="container-fluid">
    <div class="row-fluid ">
        ...
        <div class="col-md-10 col-lg-8 price_warn">
