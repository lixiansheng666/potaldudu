            ...
            <nav class="navbar col-lg-8 center-header" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <div class="header-logo col-sm-9 heade-logo" style="padding-right: 0px;padding-top:10px;padding-bottom:10px;">
                        <a class="logoLong" href="http://www.ubibot.cn/" style="float: left;"><img src="<?php echo get_template_directory_uri(); ?>/images/ico/newLogo.png" ></a>
                    </div>
...
<!--                    </li>-->
                    <li>
                        <a href="http://www.ubibot.cn/category/faqs/">社区与文档</a>
                    </li>
                    <li>
