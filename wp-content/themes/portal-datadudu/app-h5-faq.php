...
<div class="wrapper">
	<div style="z-index:999;position:absolute;top:0px;width:100%;padding: 10px 0px;border-bottom:1px solid #e7e7e7;background-color:#EFEFF4;">
...
//	var_dump($target1);
	...
	<div class="app-visited-font" style="background-color: #fff;margin-bottom: 10px;padding: 20px;">
	    ...
	    <span style="margin-left: 10px;font-size:18px;color: #000;">轻松连<sup>&reg;</sup><?php echo $cat->name;?><span style="float: right;font-size: 18px;margin-top:10%;">></span></span>
		</a>
