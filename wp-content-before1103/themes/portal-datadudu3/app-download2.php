...
/**
 * Template Name:app-download-old
 *
 */
get_header(); ?>
<div id="slider">
...
<div class="text-center">
		...
		<button type="button" onclick="window.open('http://www.ubibot.cn/download/634/')" class="btn btn-default btn-lg" style="background-color: rgba(255,255,255,.15);width: 200px">
