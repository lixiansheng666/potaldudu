...
<div class="row-fluid">
    <div class="aboutUs col-xs-12 col-sm-12 col-md-4 col-lg-4">
       <h2 class="about-company">公司介绍</h2><span>Company Introduction</span>
        ...
        <div class="text-right"><button type="button" class="btn btn-default btn-xs" style="width: 70px;border-radius: 50px;color: #000;" onclick="javascrtpt:window.location.href='<?php echo get_permalink(52);?>'">更多>></button></div>
    </div>
    ...
    <div class="news col-xs-12 col-sm-12 col-md-4 col-lg-4" style="margin-bottom: 40px">
        ...
        <div class="text-right"><button type="button" class="btn btn-default btn-xs" style="width: 70px;border-radius: 50px;color: #000;" onclick="javascrtpt:window.location.href='http://www.cloudforce.cn/company-news/'">更多>></button></div>
    </div>
    ...
    <div class="industry-news col-xs-12 col-sm-12 col-md-4 col-lg-4">
        ...
        <div class="text-right"><button type="button" class="btn btn-default btn-xs" style="width: 70px;border-radius: 50px;color: #000;" onclick="javascrtpt:window.location.href='http://www.cloudforce.cn/related-news/'">更多>></button></div>
    </div>
</div>
        ...
        <div class="box" style="margin-top:50px;" id="sideOld">
            <div class="picbox">
                ...
                <ul class="piclist mainlist">
                    <li><a href="http://www.ubibot.cn" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/ubibot.png" width="220" height="105" alt="无线智能感知标签" /></a> <h3 class="text-center">无线智能感知标签</h3></li>
