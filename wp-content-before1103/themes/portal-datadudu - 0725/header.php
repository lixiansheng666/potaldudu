        ...
        <div class="row-fluid">
            <nav class="navbar navbar-default" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <div class="header-logo col-sm-12 heade-logo" >
                        <a class="logoLong" href="#" style="float: left;"><img src="<?php echo get_template_directory_uri(); ?>/images/ico/newLogo.png" ></a>
                        <a class="logoShort" href="#" style="float: left;"><img src="<?php echo get_template_directory_uri(); ?>/images/ico/index-log.png" ></a>
                    </div>

                </div>

				 <div class="collapse col-md-9  navbar-right dropdown " id="example-navbar-collapse">

                <ul class="nav navbar-nav  header-nav">
                    <li>
                        <a href="http://www.ubibot.cn/">首页</a>
                    </li>
                    <li>
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="margin-right: 335px;width:425px">
                            <li role="" >
                              ...
                              <a href="http://www.ubibot.cn/ubibot-ws1/"> <img src="<?php echo get_template_directory_uri(); ?>/images/ico/dudu_tag.png"></a>
                    ...
                    <li>
                        <a href="http://console.ubibot.cn/login.html" target="_blank">管理控制台</a>
                    </li>
                    <li>
                        <a href="http://www.ubibot.cn/pricing/">计费方式</a>
                    </li>
<!--                    <li>-->
<!--                        <a href="http://www.ubibot.cn/news/">新闻活动</a>-->
<!--                    </li>-->
                    <li>
                        <a href="http://www.ubibot.cn/docs/ubibot-api-docs/">社区与文档</a>
                    </li>
                    <li>
                        <a href="http://www.ubibot.cn/aboutus/">关于我们</a>
                    </li>
                    <li>
                        <a href="http://www.ubibot.cn/setup/">软件及APP下载</a>
                    </li>
                </ul>
            </div>
            </nav>
