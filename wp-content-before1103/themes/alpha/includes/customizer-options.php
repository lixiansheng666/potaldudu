...
function alpha_customizer( $wp_customize ) {
	...
	////////////////////////
	 ...
	 $wp_customize->add_section('sidebar', array(
		'title' => esc_html__( 'Logo', 'alpha' ),
		'priority' => 12
	));
	 $wp_customize->add_section('nav', array(
		'title' => esc_html__( 'Navigation', 'alpha' ),
		'priority' => 14
	));
	 $wp_customize->add_section('ajax', array(
		'title' => esc_html__( 'AJAX', 'alpha' ),
		'priority' => 22
	));
	 $wp_customize->add_section('footer', array(
		'title' => esc_html__( 'Footer', 'alpha' ),
		'priority' => 18
	));
	 $wp_customize->add_section('colors', array(
		'title' => esc_html__( 'Colors', 'alpha' ),
		'priority' => 19
	));
	...
	$wp_customize->add_control(
	    new WP_Customize_Image_Control(
	        ...
	        'alpha_logo_light',
	        array(
	            'label' => esc_html__( 'Light logo', 'alpha' ),
	            'section' => 'sidebar',
	            'settings' => 'alpha_logo_light'
	        )
	    )
	);
	...
	$wp_customize->add_control(
	    new WP_Customize_Image_Control(
	        ...
	        'alpha_logo_dark',
	        array(
	            'label' => esc_html__( 'Dark logo', 'alpha' ),
	            'section' => 'sidebar',
	            'settings' => 'alpha_logo_dark'
	        )
	    )
	);
	...
	$wp_customize->add_setting(
		'alpha_logo_width', array(
			'default' => '70',
			'type' => 'option',
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_basic_number'
		)
	);
	$wp_customize->add_control('alpha_logo_width', 
		array(
			'label' => esc_html__( 'Logo width', 'alpha' ),
			'section' => 'sidebar',
			'settings' => 'alpha_logo_width',
			'type' => 'text'
		)
	);

	function sanitize_basic_number( $number ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			$wp_customize,
			'alpha_menu_bg_color', array(
				'label' => esc_html__( 'Menu background color (dark)', 'alpha' ),
				'section' => 'nav',
				'settings' => 'alpha_menu_bg_color',
				'priority' => 12
			)
		)
	);
	...
	$wp_customize->add_control(
	    new WP_Customize_Image_Control(
	        ...
	        'alpha_menu_bg_img',
	        array(
	            'label' => esc_html__( 'Menu background image (dark)', 'alpha' ),
	            'section' => 'nav',
	            'settings' => 'alpha_menu_bg_img',
				'priority' => 13
	        )
	    )
	);
	...
	$wp_customize->add_setting(
		'alpha_menu_text', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'alpha_validate_textarea'
		)
	);
	$wp_customize->add_control('alpha_menu_text', 
		array(
			'label' => esc_html__( 'Menu text', 'alpha' ),
			'section' => 'nav',
			'settings' => 'alpha_menu_text',
			'type' => 'textarea',
			'priority' => 15
		)
	);

	function alpha_validate_textarea( $textarea_box ) {
		return wp_kses($textarea_box, array(
			'a' => array(
				'href' => array(),
				'title' => array()
			),
	...
	$wp_customize->add_setting(
		'alpha_ajax', array(
			...
			'type' => 'option',
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'alpha_validate_basic_select'
		)
	);
	$wp_customize->add_control('alpha_ajax', 
		array(
			'label' => esc_html__( 'Enable AJAX portfolio / blog', 'alpha' ),
			'section' => 'ajax',
			'settings' => 'alpha_ajax',
			'description' => esc_html__( 'To be disabled if you\'re using certain plugins which are broken by the AJAX functionality (loading of portfolio & blog posts with nice effects and without the page refresh).', 'alpha' ),
			'type' => 'select',
			'choices' => array(
				'enabled' => esc_html__( 'Enabled', 'alpha' ),
				'disabled' => esc_html__( 'Disabled', 'alpha' )
			),
			'priority' => 1
		)
	);

	function alpha_validate_basic_select( $select_box ) {
		if ( in_array( $select_box, array('enabled', 'disabled'), true ) ) {
			return $select_box;
		}
	}
	...
	$wp_customize->add_setting(
		'alpha_footer_type', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'alpha_validate_footer_select'
		)
	);
	$wp_customize->add_control('alpha_footer_type', 
		array(
			'label' => esc_html__( 'Choose footer style', 'alpha' ),
			'section' => 'footer',
			'settings' => 'alpha_footer_type',
			'type' => 'select',
			'choices' => array(
				'minimal' => esc_html__( 'Minimal', 'alpha' ),
				'normal' => esc_html__( 'Minimal + Secondary', 'alpha' )
			),
			'priority' => 1
		)
	);

	function alpha_validate_footer_select( $select_box ) {
		if ( in_array( $select_box, array('minimal', 'normal'), true ) ) {
			return $select_box;
		}
	}

	$wp_customize->add_setting(
		'alpha_footer_img', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'esc_url_raw'
	...
	$wp_customize->add_control(
	    new WP_Customize_Image_Control(
	        ...
	        'alpha_footer_img',
	        array(
	            'label' => esc_html__( 'Secondary footer\'s background (dark image)', 'alpha' ),
	            'section' => 'footer',
	            'settings' => 'alpha_footer_img',
				'priority' => 3
	        )
	    )
	);
	...
	$colorsArray = array(
		array(
			'label' => esc_html__( 'Main Color', 'alpha' ),
			'default' => '#b99d61',
			'setting' => 'main1'
		)
	);
	...
	foreach($colorsArray as $color){
		...
		$wp_customize->add_setting(
			'alpha_colors[' . $color['setting'] . ']', array(
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				'alpha_colors[' . $color['setting'] . ']', array(
					'label' => $color['label'],
					'section' => 'colors',
					'settings' => 'alpha_colors[' . $color['setting'] . ']',
					'priority' => $i++
				)
			)
		);
	...
	$wp_customize->add_setting(
		'alpha_type_heading', array(
			'default' => 'Raleway',
			'type' => 'option',
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'alpha_sanitize_font'
		)
	);
	$wp_customize->add_control('alpha_type_heading', 
		array(
			'label' => esc_html__( 'Headings Font', 'alpha' ),
			'section' => 'typography',
			'settings' => 'alpha_type_heading',
			'type' => 'select',
	...
	$wp_customize->add_control('alpha_type_body', 
		array(
			'label' => esc_html__( 'Body Font', 'alpha' ),
			'section' => 'typography',
			'settings' => 'alpha_type_body',
			'type' => 'select',
			'choices' => $google_fonts_simple,
			'priority' => 2
		)
	...
	$wp_customize->add_control('alpha_type_quotes', 
		array(
			'label' => esc_html__( 'Quotes Font', 'alpha' ),
			'section' => 'typography',
			'settings' => 'alpha_type_quotes',
			'type' => 'select',
			'choices' => $google_fonts_simple,
			'priority' => 3 
		)
	...
	function alpha_sanitize_font( $font ) {
		return $font;
	}

}

add_action('customize_register', 'alpha_customizer');
