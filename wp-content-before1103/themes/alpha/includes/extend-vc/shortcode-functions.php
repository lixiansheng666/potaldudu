...
function alpha_parse_flickr_feed( $id, $no ) {
	...
	for ( $i = 0; $i < count( $items[1] ); $i++ ) {
		...
		//$thumb = str_replace( '_s.jpg', '_m.jpg', alpha_parse_flickr_attr( $temp[0][0], "url" ) );
		$thumb = alpha_parse_flickr_attr( $temp[0][0], "url" );
...
function alpha_parse_flickr_attr( $s, $attrname ) { 
