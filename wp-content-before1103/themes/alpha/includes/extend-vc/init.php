...
if ( function_exists( 'vc_set_as_theme' ) ) {
	...
	include( get_template_directory() . '/includes/extend-vc/dependencies.php' );
	include( get_template_directory() . '/includes/extend-vc/map.php' );
	include( get_template_directory() . '/includes/extend-vc/shortcode-functions.php' );
	include( get_template_directory() . '/includes/extend-vc/shortcodes.php' );
	...
	include( get_template_directory() . '/includes/extend-vc/vc_tt_shortcodes.php' );
