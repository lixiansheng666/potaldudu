<?php
	...
	$size_arr = array(esc_html__("Small", 'alpha') => "small", esc_html__("Medium", 'alpha') => "normal",  esc_html__("Large", 'alpha') => "large");

	$target_arr = array(esc_html__("Same window", 'alpha') => "_self", esc_html__("New window", 'alpha') => "_blank");
	...
	$add_css_animation_1 = array(
	  "type" => "dropdown",
	  "heading" => esc_html__("CSS Animation", 'alpha'),
	  "param_name" => "css_animation",
	  "admin_label" => true,
	  "value" => array(esc_html__("No", 'alpha') => '', esc_html__("Simple fade", 'alpha') => 'simple', esc_html__("Fade from top", 'alpha') => "top-to-bottom", esc_html__("Fade from bottom", 'alpha') => "bottom-to-top", esc_html__("Fade from left", 'alpha') => "left-to-right", esc_html__("Fade from right", 'alpha') => "right-to-left", esc_html__("Appear from center", 'alpha') => "appear"),
	  "description" => esc_html__("Select type of animation if you want this element to be animated when it enters into the browsers viewport. Note: Works only in modern browsers.", 'alpha')
	);
	$add_css_animation_2 = array(
	  "type" => "dropdown",
	  "heading" => esc_html__("Animation speed", 'alpha'),
	  "param_name" => "css_animation_speed",
	  "value" => array( "0.5s" => 'faster', "1s" => 'default', "2s" => 'slower', "3s" => 'even-slower'),
	  "description" => esc_html__("Select the speed of the animation.", 'alpha'),
	  "dependency" => Array('element' => "css_animation", 'not_empty' => true)

	);
	$add_css_animation_3 = array(
	  "type" => "textfield",
	  "heading" => esc_html__("Animation delay", 'alpha'),
	  "param_name" => "css_animation_delay",
	  "value" => "0",
	  "description" => esc_html__("Select the delay of the animation(in milliseconds).", 'alpha'),
	  "dependency" => Array('element' => "css_animation", 'not_empty' => true)
	);*/
