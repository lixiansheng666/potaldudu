						...
						jQuery(document).ready(function($) {
							$('.dh-meta-gallery-select').on('click',function(e){
								...
								dh_meta_gallery_frame = wp.media({
									title: '<?php echo esc_js(__('Add Images to Gallery','sitesao'))?>',
									button: {
										text: '<?php echo esc_js(__('Add to Gallery','sitesao'))?>',
									},
									library: { type: 'image' },
									multiple: true
								});
											...
											dh_meta_gallery_list.append('\
												<li data-id="' + attachment.id +'">\
													<div class="thumbnail">\
														...
														<a href="#" title="<?php echo esc_js(__('Delete','sitesao'))?>">x</a></li>\
													</div>\
												</li>'
											);
										}
							...
							?>
								<li data-id="<?php echo esc_attr( $attachment_id ) ?>">
									<div class="thumbnail">
										...
										<a title="<?php echo __('Delete','sitesao') ?>" href="#">x</a>
									</div>						
								</li>
							<?php
								endif;
						...
						jQuery(document).ready(function($) {
							...
							$('#<?php echo esc_attr($field['id']) ?>_upload').on('click', function(event) {
								...
								var dh_<?php echo esc_attr($field['id']); ?>_media_frame = wp.media.frames.wp_media_frame = wp.media({
									title: "<?php echo esc_js(__( 'Select or Upload your Media', 'sitesao' )); ?>",
									button: {
								...
								dh_<?php echo esc_attr($field['id']); ?>_media_frame.on('select', function(){
									...
									$this.attr('value', '<?php echo esc_js(__( 'Change Media', 'sitesao' )); ?>');
							...
							$('#<?php echo esc_attr($field['id']) ?>_clear').on('click', function(event) {
								var $this = $(this);
								$this.hide();
								$('#<?php echo esc_attr($field['id']) ?>_upload').attr('value', '<?php echo esc_js(__( 'Select Media', 'sitesao' )); ?>');
