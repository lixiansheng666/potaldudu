...
function dhwc_product_dropdown_brands($args=array()){
	...
	$output .= '<option value="" ' .  selected( $current_product_brand, '', false ) . '>' . __( 'Select a brand', 'sitesao' ) . '</option>';
	$output .= woocommerce_walk_category_dropdown_tree( $terms, 0, $args );
	if ( $args['show_uncategorized'] ) {
		$output .= '<option value="0" ' . selected( $current_product_brand, '0', false ) . '>' . __( 'Uncategorized', 'sitesao' ) . '</option>';
	}
	$output .= "</select>";
